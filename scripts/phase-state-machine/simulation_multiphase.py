...
from mujoco_irb120.common.phase_controller import PhaseController, Phase
...
_params  = _json.load(open(_REPO_ROOT / "scripts" / "object_params.json"))["objects"][str(OBJECT)]
